...
class Boss:
    ...
    #def __init__(self):
    #    self.mysound = 32
    #    self.bossatt = load_music("music\\bossattack.mp3")
    #    self.bossenter = load_music("music\\bossenter.mp3")
    #    self.bossatt.set_volume(self.mysound)
    #    self.bossenter.set_volume(self.mysound)
    def SetDes(self, x, y):
        self.DesX = x
        self.DesY = y
...
class Monster:
    ...
    def __init__(self, x,y,degree,framesize):
        #self.mysound = 32
        #self.mobhit = load_music("music\\mobhit.mp3")
        #self.mobhit.set_volume(self.mysound)
        self.X = x
        self.Y = y
        self.Degree = degree
        self.frame = 0
...
class Elec:
    ...
    def Set(self,x,y):
        ...
        self.Live = True
    def Check(self):
        if(self.StartTime + 0.5 < Timer.Time_Start):
            self.live = False
...
class Player:
    ...
    def __init__(self,x,y,life,speed,framesize):
       #self.mysound = 32
       #self.playeratt.set_volume(self.mysound)
       #self.playerhit.set_volume(self.mysound)
       #self.playeratt = load_music("music\\playeratt.mp3")
       #self.playerhit = load_music("music\\playerhit.mp3")
        self.X = x
        self.Y = y
        self.Life = life
        self.Speed = speed
