            ...
            if event.type == SDL_MOUSEBUTTONDOWN:
                ...
                if ( 490 < Global.MyMouse[0] < 610):
                    if (40 < Global.MyMouse[1] < 120):
                        ...
                        Global.stage = "main"
                        Global.g_Level = -1
                        Global.g_Player.MaxLife = 5
                        Global.g_Player.BulletPower = 12
                        Global.g_Player.BulletSpeed = 15
                        Global.g_Player.BulletNum = 5
                        Global.g_Player.frame= 0
                        for i in range(0,8):
                            Global.MyItem.inven[i] = Item(-1," "," ",-1)
